...
<form:form action="/PatientAppointmentTrackingSystem/home/doctorprocess" modelAttribute="doctor">

Name:<form:input path="doctorName"/>
Gender:<form:input path="doctorGender"/>
Email:<form:input path="doctorEmail"/>
Password:<form:password path="doctorPassword"/>
Specialization:<form:input path="doctorSpecliest"/>
<input type="submit"/>
 <a href="/PatientAppointmentTrackingSystem/login/doctorlogin">Already Have a Account Click here</a>
 </form:form>
