...
<form:form action="/PatientAppointmentTrackingSystem/home/adminprocess" modelAttribute="admin">

Name:<form:input path="adminName"/>
Gender:<form:input path="adminGender"/>
Email:<form:input path="adminEmail"/>
Password:<form:password path="adminPassword"/>
<input type="submit"/>
 <a  class="link"href="/PatientAppointmentTrackingSystem/login/adminlogin">Already Have a Account Click here</a>
